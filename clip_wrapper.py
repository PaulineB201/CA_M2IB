"""
This code is based on M2IB https://github.com/YingWANGG/M2IB/tree/main, and CLIP https://github.com/openai/CLIP .
"""
import copy
import torch
...
class VisionEmbeddings(nn.Module):
    ...
    def forward(self, x):
        x = self.patch_embedding(x.to(self.dtype))  # [*, width, grid, grid]
